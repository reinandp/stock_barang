...
<div class="row">
    <div class="col-sm-12 col-md-10">
        <h4 class="mb-0"><i class="fa fa-reply"></i> Edit Data Barang Keluar</h4>
    </div>
</div>
<hr class="mt-0" />
<div id="message">
...
<div class="col-md-12">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-2">
            <input type="number" class="form-control form-control-sm qty" id="jumlahx" placeholder="Jumlah Beli">
        </div>
    </div>
    <div class="form-group row">
